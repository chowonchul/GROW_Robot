ZERO G6A,103, 102, 108,  93, 100, 100
ZERO G6B, 98, 101, 100, 100, 100, 100
ZERO G6C, 98, 101, 100, 100, 100, 100
ZERO G6D, 97, 100, 108,  93, 100, 100
...
자이로MAX:
    ...
    GYROSENSE G6A,250,250,250,250,
    GYROSENSE G6D,250,250,250,250,

    RETURN
    '***********************************************
자이로MID:

    GYROSENSE G6A,250,150,150,150,
    GYROSENSE G6D,250,150,150,150,
...
자이로ON:
    ...
    GYROSET G6A, 2, 1, 1, 1, '2
    GYROSET G6D, 2, 1, 1, 1, '2
...
기본자세1:
    ...
    MOVE G6C,100,  30,  80, 100, 136, 100
